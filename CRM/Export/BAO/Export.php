  ...
  static function exportComponents($selectAll,
    ...
    if ($fields) {
      ...
      if ($primary) {
        ...
        $returnProperties['address_id'] = 1; // KJ 11/06/2015 return address, email and phone ids too if primary option is selected in export 
        $returnProperties['email_id'] = 1;
        $returnProperties['phone_id'] = 1;
      }
